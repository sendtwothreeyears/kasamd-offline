...
**Source:** http://www.soapnote.org:80/mental-health/gujarati-phq-9/
...
Score --> [calc value="score=(Q1)+(Q2)+(Q3)+(Q4)+(Q5)+(Q6)+(Q7)+(Q8)+(Q9)" memo="score"] out of 27 points.  
Interpretation --> [calc value="score=(Q1)+(Q2)+(Q3)+(Q4)+(Q5)+(Q6)+(Q7)+(Q8)+ (Q9);score>20?'Severe':score>14?'Moderately Severe':score>9?'Mild':score>4?'Minimal Symptoms':'Asymptomatic'" memo="interpretation"]

[checkbox memo="display/hide references" name="footnotes" value=""][conditional field="footnotes" condition="(footnotes).is('')"]
reference:  
[link url="http://www.ncbi.nlm.nih.gov/pubmed/11556941" memo="#1"] Drs. Robert L. Spitzer, Janet B.W. Williams, Kurt Kroenke અને સહયોિગયો  વારા Pfizer Inc થી શૈ િણક અનુદાન ની સહાયતા થી િવકિસત । અનુવાદ,  િતિલપી તૈયાર કરવા,  કાિશત અથવા િવતરણ કરવા અનુમિતની આવ યકતા નથી।
[/conditional]
