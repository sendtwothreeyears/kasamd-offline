...
**Source:** https://www.soapnote.org/complete/full-woman-health-2/
...
Purpose of Visit/CC:
[checkbox name="purpose" value="annual screening|new problem|follow up on abnormal|"][textarea cols=70 rows=1]
Breast Sx:
[checkbox name="breast_cc" value="does not report||pain|swelling|lump|discharge|skin changes|abnormal imaging|family history|"][textarea cols=70 rows=1]
GI Sx:
[checkbox name="abdominal_cc" value="does not report||upper abd pain|lower abd pain|diarrhea|constipation|nausea/vomiting|"][textarea cols=70 rows=1]
Menstrual Sx:
[checkbox name="menstrual_cc" value="does not report||irregular menstruation|heavy menses|painful menses|spotting|missed|"][textarea cols=70 rows=1]
LMP: [textarea cols=10 rows=1 default="N/A"]
Urinary Sx:
[checkbox name="urinary_cc" value="does not report||burning|frequency|pain with urination|blood in urine|back pain||stress incontinence|urge incontinence|"][textarea cols=70 rows=1]
Vaginal Sx:
[checkbox name="vaginal_cc" value="does not report||clear discharge|thick discharge|yellow discharge|brown discharge||itching|skin lesions||painful intercourse|postcoital bleeding|prolapse||vaginal bleeding|vaginal clots|vaginal tissue||started several days ago|started today|"][textarea cols=70 rows=1]
Sexual Hx:
[checkbox name="sexual" value="declined|N/A||active|inactive|no new partners||known/suspected exposure|inconsistent condom use|new partner|partner w STI|non-monogamous partner||vaginal|oral|anal||previous STI|"][textarea cols=70 rows=1]
Last unprotected intercourse: [textarea cols=10 rows=1 default="N/A"]
Birth Control/HRT:
[checkbox name="birth_control" value="none||BCP|Depo|implant|IUD|BTL|condoms|"][textarea cols=70 rows=1]
Smoking:
[checkbox name="smoking" value="no|yes|"][textarea cols=70 rows=1]

HPI:
Recent History: [textarea cols=40 rows=1]
[checklist name="recent" value="stress|travel|new sexual partner|injury|PCP/UC visit|ER visit|hospitalization/surgery/procedure|new medications|antibiotic use|diagnostic study"]
Duration:
[checkbox name="duration" value="N/A|hours|days|weeks|"][textarea cols=70 rows=1]
Symptoms:
[checkbox name="sx" value="N/A||increasing in severity|remaining constant|decreasing in severity||constant|come and go|cyclic|worse with menses|worse with caffeine|"][textarea cols=70 rows=1]
Imaging:
[checkbox name="imaging" value="N/A||mammogram UTD|normal|abnormal|mammogram not UTD||ultrasound|MRI|"][textarea cols=70 rows=1]
PAP:
[checkbox name="imaging" value="N/A||normal|abnormal|unsatisfactory||EC/TZ component present| EC/TZ component absent||ASC-US|LSIL|ASC-H|HSIL|AGC|AIS|CIS||HPV POS|HPV NEG|"][textarea cols=70 rows=1]
Family Hx:
[checkbox name="family" value="N/A||breast ca|ovarian ca|colon ca|"][textarea cols=70 rows=1]
PMH:
reviewed
[checkbox name="pmh" value="noncontributory||frequent UTIs|kidney stones|incontinence||ovarian cyst|endometriosis|fibroids||breast ca||DM|immunosuppression|"][textarea cols=70 rows=1]
Pregnancy: [textarea cols=10 rows=1 default="N/A"]
[checkbox memo="pregnancy" name="notes2" value=" "][conditional field="notes2" condition="(notes2).is(' ')"][checklist name="gyn_symptoms" value="ectopic pregnancy|induced abortion|spontaneous abortion"][/conditional][textarea cols=70 rows=1]
PSH:
[checkbox name="psh" value="breast biopsy|breast implants|breast reduction||CS|salpingo-oophorectomy|hysterectomy||colposcopy|D&C|"][textarea cols=70 rows=1]
...
Head/Face:
[checkbox name="head" value="normocephalic, atraumatic|symmetrical face|CN grossly intact||plethoric face|alopecia|facial droop|"][textarea cols=70 rows=1]

Eyes:
[checkbox name="eyes" value="clear conjunctiva w/o exudates or hemorrhage, anicteric sclera, EOM intact without nystagmus|visual acuity grossly intact|cornea(s) clear||glasses|contacts|conjunctival injection|epiphora|"][textarea cols=70 rows=1]
...
Nose:
[checkbox name="nose" value="nares patent bilaterally|septum midline|no facial tenderness|mucosa pink & moist||swollen & boggy mucosa|mucosal congestion|clear discharge|"][textarea cols=70 rows=1]
...
Throat:
[checkbox name="throat" value="normal voice|patent pharynx w/o swelling or exudates|uvula midline|clear pharynx w/o exudates||hoarseness|pharyngeal erythema w/o exudates|pharyngeal crowding|"][textarea cols=70 rows=1]
...
Lungs:
[checkbox name="lungs" value="normal work of breathing, symmetrical chest expansion, no stridor|clear and equal breath sounds bilaterally||SOB|decreased bilaterally|wheezing|crackles|"][textarea cols=70 rows=1]

Right Breast:  [textarea cols=40 rows=1]
[checklist name="right_breast" value="implant|density|skin changes|tenderness|nipple changes|nipple discharge|mass|axillary LAD|supraclavicular LAD|infraclavicular LAD"]

Left Breast: [textarea cols=40 rows=1]
[checklist name="right_breast" value="implant|density|skin changes|tenderness|nipple changes|nipple discharge|mass|axillary LAD|supraclavicular LAD|infraclavicular LAD"]

Mass:
[checkbox name="mass" value="none||r breast|left breast||round|oval|irregular||well-defined margins|ill-defined margins||less than 1 cm|1 to 3 cm|larger than 3 cm|| soft|firm|rubbery|hard||fixed|mobile|"][textarea cols=70 rows=1]
...
Abdomen:
[checkbox name="abd" value="not examined||normal visual inspection, no distension|normal active bowel sounds|soft non-tender||protruding|surgical scar|umbilical hernia|diffuse tenderness over entire abdomen w/o RRG|direct non-rebound tenderness|colostomy in situ|"][textarea cols=70 rows=1]

MSK:
[checkbox name="spine" value="no gross deformities, moves all extremities with good ROM for age|full weight-bearing|normal curvature & ROM in C- & L-spine for patient’s age||non-tender C-spine with good ROM|non-tender L-spine with good ROM||strength, tone, & bulk symmetrical & grossly intact|"][textarea cols=70 rows=1]

Neuro:
[checkbox name="neuro" value="normal concentration and attention|memory grossly intact||balance & coordination grossly intact|normal speech|no gross motor deficits||sensation symmetrical & grossly intact|extremities strong w/o atrophy, tremor or fasciculations|reflexes normoactive||antalgic gait|wide gait|shuffling gait|"][textarea cols=70 rows=1]
...
Pelvic Exam:
[checkbox name="pelvic" value="normal||below|declined|"][textarea cols=70 rows=1]
Vulva:
[checkbox name="vulva" value="normal||atrophy|discharge|condylomata|"][textarea cols=70 rows=1]
Vagina:
[checkbox name="vagina" value="normal||cystocele|rectocele|Bartholin's||erythema|atrophy||milky discharge|curdy discharge|greenish/yellowish discharge||active bleeding|clots|tissue in vault|"][textarea cols=70 rows=1]
Cervix:
[checkbox name="cervix" value="normal|non-tender||motion tenderness|erosions|Nabothian cyst|discharge|"][textarea cols=70 rows=1]
Uterus:
[checkbox name="uterus" value="normal||tenderness|mass|enlarged|"][textarea cols=70 rows=1]
Adnexa:
[checkbox name="adnexa" value="non-tender||tenderness|enlargement|masses|"][textarea cols=70 rows=1]
Rectal:
[checkbox name="rectal" value="declined||normal tone||hemorrhoids|masses|"][textarea cols=70 rows=1]
...
UA:
[checkbox name="office_ua" value="non-specific changes|normal|suggestive of UTI||leukocytes|nitrites|glucose|blood|declined||urine cx sent out|"][textarea cols=70 rows=1]
hcg:
[checkbox name="office_hcg" value="N/A||positive home test||negative clinic test|positive clinic test|declined|"][textarea cols=70 rows=1]
...
OUTSIDE LABS:
[checkbox name="collected" value="PAP|urine|BV swab||CBC|CMP||STI|"][textarea cols=70 rows=1]

RX:
[checkbox name="order_RX" value="none|ABX|Pyridium 100 mg TID #6|Rx for suspected vaginosis|Rx for suspected STI||electronic|paper|given to MA to be transmitted to pharmacy|"][textarea cols=70 rows=1]

REVIEWED:
[checkbox name="reviewed" value="MA notes|previous visits|PMP|laboratory/diagnostic studies|"][textarea cols=70 rows=1]

INSTRUCTED ON:
[checkbox name="instructions" value="vital signs,exam & testing findings|reporting medication side effects to clinic immediately|appropriate follow up with PCP|weight reduction|dietary changes|exercise|family planning|contraceptive options|emergency contraception|safe sex|SBE|mammogram if older than forty|osteoporosis prevention & screening|smoking cessation|"][textarea cols=70 rows=1]
...
DISPOSITION:
[checkbox name="disposition" value="RTC as discussed, sooner if condition worsens or new symptoms arise, contact 911/ER if significant increase in s/sx or appearance of new/danger s/sx, PRN||RTC 1 week|RTC 6 months|RTC 12 months||screening mammo|diagnostic mammo|diagnostic ultrasound||surgeon|GYN||referred to ER for immediate treatment via 911|referred to ER for immediate treatment via private transport|declined emergency transfer|left clinic before being discharged|asked to leave clinic|"][textarea cols=70 rows=1]
