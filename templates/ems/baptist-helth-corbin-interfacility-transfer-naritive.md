# Baptist Helth Corbin Interfacility Transfer Naritive

**Category:** Emergency Medical Services
**Source:** https://www.soapnote.org/ems/baptist-helth-corbin-interfacility-transfer-naritive/

---

CREW LOCATED PATIENT ROOM IN [select name="Unit" value="Medical/Surgical|Telemetry|Progressive|Physical Rehab|CCU|ED 1|ED 2|Cath Lab|BHU"] AND THE NURSE IN CHARGE OF PATIENT. OBTAINED DOCUMENTATION FOR TRANSPORT, VERIFIED DESTINATION, ESTABLISHED CURRENT DIAGNOSIS OF [text name="admitdx" size = 30 default=" "].
...
INTER-FACILITY TRANSFER FOR FOLLOWING REASON: [checkbox name="TRANSFER" value="SERVICES NOT AVAILABLE AT PRESENT FACILITY IN|HIGHER LEVEL OF CARE IN|CARDIOLOGY|NEUROLOGY|SURGERY|BEHAVIORAL MEDICINE|OBGYN|STROKE|TRAUMA|BURN UNIT|CRITICAL CARE|NEPHROLOGY|IMAGING|GASTROENTEROLOGY|PLUMOLOGY"][text name="TRANSFER" default=" "]
...
HISTORY:[text name="Hx" size = 60 default=" "][checklist name="ATTHX" value="SEE ATTACHED CHART"]
ALLERGIES:[text name="Allergies" size = 30 default=" "][checklist name="ATTALG" value="SEE ATTACHED CHART"]
MEDICATIONS[text name="Meds" size = 60 default=" "][checklist name="ATTMED" value="SEE ATTACHED CHART"]
