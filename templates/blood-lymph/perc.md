...
**Category:** Featured
**Source:** http://www.soapnote.org:80/blood-lymph/perc/

---

This tool can be used to rule out pulmonary embolism if the pre-test probability of PE is low.  A Wells PE Score of 1 or 0 is one way to meet this requirement (1.3% probability).  [link url="../../blood-lymph/wells-pe/" memo="Wells PE Score calculator"]
...
reference:  [link url="http://www.ncbi.nlm.nih.gov/pubmed/15304025" memo="#1"] Kline (2004) J Thromb Haemost. 2:1247-55.
[/conditional]
