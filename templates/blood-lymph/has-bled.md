...
**Source:** https://www.soapnote.org/blood-lymph/has-bled/
...
[select name="Q3" value="no (0 points)=0|YES (1 point)=1"] <-- Cirrhosis or bilirubin > 2x normal, Alkaline phosphatase > 3x normal, liver transaminases > 3x normal
...
reference:
[link url="http://www.ncbi.nlm.nih.gov/pubmed/20299623" memo="link"] Pisters R, Lane DA, Nieuwlaat R, de Vos CB, Crijns HJ, Lip GY. A novel user-friendly score (HAS-BLED) to assess 1-year risk of major bleeding in patients with atrial fibrillation: the Euro Heart Survey. Chest. 2010 Nov;138(5):1093-100 [/conditional]
